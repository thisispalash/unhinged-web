...
export default function BaitPageTemplate0() {
  ...
  return <>
      <head>
        ...
        <meta name="twitter:image" content="https://nhinged.io/img/template0.png" />
        ...
        <meta name="og:image" content="https://nhinged.io/img/template0.png" />
      ...
      <div className={cn(
        ...
        <div className={cn(
          ...
          <div className={cn(
            ...
            <img src={"/img/template0.png"} alt="arena" className={cn(
              'aspect-3/4',
