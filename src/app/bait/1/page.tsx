...
export default function BaitPageTemplate1() {
  ...
  return <>
      <head>
        ...
        <meta name="twitter:image" content="https://nhinged.io/img/template1.png" />
        ...
        <meta name="og:image" content="https://nhinged.io/img/template1.png" />
      ...
      <div className={cn(
        ...
        <div className={cn(
          ...
          <img src={"/img/template1.png"} alt="arena" className={cn(
            'aspect-4/3',
